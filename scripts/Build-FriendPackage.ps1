...
$buildInfo = [ordered]@{
    ...
    motionReplication = '34.0-navigation-owned-remote-motion-bounded-hard-resync-and-collision-gated-spawn'
    animGraphReader = 'native-locomotion-probe-movenetwork-fail-closed'
    animGraphMemoryReaderEnabled = $false
    animGraphVisualDriver = '34.0-navigation-owned-eight-way-direction-native-gait-ik-and-traversal-recovery'
    ...
    physicalRootRecovery = 'sustained-six-meter-or-emergency-twelve-meter-only'
    ...
    remoteMount = '34.0-single-navigation-controller-collision-gated-spawn-and-twelve-meter-emergency-recovery'
