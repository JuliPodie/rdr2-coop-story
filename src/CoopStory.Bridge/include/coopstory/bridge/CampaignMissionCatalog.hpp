...
inline constexpr CampaignMissionDefinition kCampaignMissionCatalog[]{
    ...
    {CampaignMissionId("WNT4"), "WNT4", "winter4", "Old Friends", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kWnt4MissionRewards},
    {CampaignMissionId("MUD1"), "MUD1", "mudtown1", "Americans at Rest", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kMud1MissionRewards},
    ...
    {CampaignMissionId("MUD4"), "MUD4", "mudtown4", "The Sheep and the Goats", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kMud4MissionRewards},
    ...
    {CampaignMissionId("UTP2"), "UTP2", "utopia2", "American Pastoral Scene", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kUtp2MissionRewards},
    {CampaignMissionId("SEN1"), "SEN1", "sean1", "The First Shall Be Last", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kSen1MissionRewards},
    {CampaignMissionId("MUD6"), "MUD6", "mudtown3b", "Pouring Forth Oil", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kMud6MissionRewards},
    ...
    {kHunt1MissionId, "HNT1", "hunting1", "Exit Pursued by a Bruised Ego", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kHunt1MissionRewards},
    {kFud1MissionId, "FUD1", "feud1", "The New South", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kFud1MissionRewards},
    {CampaignMissionId("GRY1"), "GRY1", "grays1", "American Distillation", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kGry1MissionRewards},
    ...
    {CampaignMissionId("TRE1"), "TRE1", "trelawny1", "Magicians for Sport", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kTre1MissionRewards},
    ...
    {CampaignMissionId("DST1"), "DST1", "odriscolls1", "Paying a Social Call", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kDst1MissionRewards},
    ...
    {CampaignMissionId("DST5"), "DST5", "odriscolls5", "Goodbye, Dear Friend", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kDst5MissionRewards},
    COOPSTORY_STORY_MISSION("IND1", "industry1", "The Gilded Cage"),
    {CampaignMissionId("IND3"), "IND3", "industry3", "A Fine Night of Debauchery", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kInd3MissionRewards},
    ...
    {CampaignMissionId("GNG3"), "GNG3", "gang3", "Visiting Hours", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kGng3MissionRewards},
    ...
    {CampaignMissionId("MAR8"), "MAR8", "marston8", "American Venom", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kMar8MissionRewards},
    COOPSTORY_STORY_MISSION("BE22", "beechers2_2", "A New Jerusalem"),
    {CampaignMissionId("AB21"), "AB21", "abigail2_1", "The Tool Box", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kAb21MissionRewards},
    COOPSTORY_STORY_MISSION("SAD2", "sadie2", "A Quick Favor for an Old Friend"),
    {CampaignMissionId("SAD3"), "SAD3", "sadie3", "Uncle's Bad Day", CampaignCompletionBinding::MissionDataRatingAndDerivedUnlocks, kSad3MissionRewards},
